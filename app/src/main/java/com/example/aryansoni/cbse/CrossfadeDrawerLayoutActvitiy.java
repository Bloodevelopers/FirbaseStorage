...
public class CrossfadeDrawerLayoutActvitiy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //it gives the details of logged in user
...
//        final IProfile profile2 = new ProfileDrawerItem().withName("Bernat Borras").withEmail("alorma@github.com").withIcon(Uri.parse("https://avatars3.githubusercontent.com/u/887462?v=3&s=460"));
        ...
        headerResult = new AccountHeaderBuilder()
                .withActivity(this)
                .withHeaderBackground(R.drawable.zxc)
                .addProfiles(
                        profile
        ...
        result = new DrawerBuilder()
                ...
                .addDrawerItems(
                        new PrimaryDrawerItem().withName("Class 1").withIcon(R.drawable.penx).withIdentifier(1),
